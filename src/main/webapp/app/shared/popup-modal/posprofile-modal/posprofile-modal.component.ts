...
@Component({
  selector: 'jhi-posprofile-modal',
  templateUrl: './posprofile-modal.component.html',
  styleUrls: ['./posprofile-modal.component.scss']
})
export class PosprofileModalComponent implements OnInit, OnChanges {
  @Input() inputId!: any;
  editing = false;
